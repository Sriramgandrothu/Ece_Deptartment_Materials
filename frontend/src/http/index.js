...
export const BASE_URL = "https://ece-deptartment-materials.onrender.com";

export const api = axios.create({
  baseURL: "https://ece-deptartment-materials.onrender.com/api",
...
api.interceptors.response.use(
  ...
  async (error) => {
    ...
    if (
      ...
      try {
        await axios.get("https://ece-deptartment-materials.onrender.com/api/auth/refresh-tokens", {
          withCredentials: true,
        });
